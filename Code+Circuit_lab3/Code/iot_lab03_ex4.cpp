...
const char *ssid = "UiTiOt-E3.1";  // Your network SSID (name)
const char *password = "UiTiOtAP"; // Your network password

const char *mqtt_server = "172.31.10.202";
const char *topic = "nt533/o22/group1/led";
...
void setup()
{
    ...
    client.publish(topic, "Hello this messenger from group 1 ");
}
